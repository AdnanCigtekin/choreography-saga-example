package com.adnancigtekin.saga.payment.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, OrderEvent> itemsAllocatedConsumerFactory(){
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "items-allocated");
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, OrderEvent>> ItemsAllocatedListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, OrderEvent> listenerContainerFactory =
                new ConcurrentKafkaListenerContainerFactory<>();
        listenerContainerFactory.setConsumerFactory(itemsAllocatedConsumerFactory());
